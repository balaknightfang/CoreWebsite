...
dataPower[dataPower.length] = new Power(1, 1, 2, "Storm Cloud", 0.5, 0, 0, 0, 34, 10, "Targets foe (5 max)/100 feet/25 foot Sphere", "Ranged AoE Damage/Negative Ions/Arc", "Deals Electrical damage to affected Targets<br /><br />15/20/25% Chance to apply Negative Ions to affected targets<br /><br />When dealing direct Electrical damage against a target affected by this power, chance to Arc to a secondary target, doing additional electrical damage to them");
dataPower[dataPower.length-1].insertAdvantage("Shocking Strikes", 2, null, "When activating this power, targets within a short range are Stunned for a short time.");
dataPower[dataPower.length-1].insertStockAdvantages("AM/CS");
...
dataPower[dataPower.length] = new Power(1, 1, 3, "Sundering Breath", 0.5, 6, 0.5, 0, [29,21], 0, "Targets foe (5 max)/50 feet/3 foot Cylinder", "Ranged  AoE Damage/Arc/Circuit", "Deals Electrical damage to Targets in front of you.<br /><br />When hitting a target affected by your Negative Ions, deals additional Electrical damage and consumes your Negative Ions."+ Aesica.HCEngine.powerUnlocksFrom("Kaiju Lockbox"));
dataPower[dataPower.length-1].insertAdvantage("Power Consumption", 2, null, "Heals you when attacking a target affected by your Negative Ions.<br /><br />+This heal is considered a Life Drain effect.");
dataPower[dataPower.length-1].insertStockAdvantages("AM/CS");
...
dataPower[dataPower.length] = new Power(1, 1, 4, "Storm Strike", 0.5, 1.5, 0, 0, 121, 60, "Affects foe (10 max)/25 foot Sphere", "Ultimate/Ranged AoE Damage", "Deals Electrical damage to all targets and they are Knocked Down.<br /><br />Deals additional damage to all targets affected by Negative Ions, consuming them in the process.<br /><br />After 2 seconds, applies Negative Ions to affected targets." + Aesica.HCEngine.powerUnlocksFrom("Rave Lockbox or " + UNLOCK_COLLECTOR, 1, UNLOCK_PURPLE_FOIL), Power.TYPE_NORMAL, true);
...
dataPower[dataPower.length] = new Power(1, 1, 4, "Meteor Blaze", 0.5, 1.5, 0, 1.5, 178, 60, "Targets foe (10 max)/50 feet/25 foot Sphere", "Ultimate/Ranged AoE Damage/Burning", "Deals Fire damage to all targets and they are Knocked Down.<br /><br />Creates a Pyre Patch beneath the target. %PyrePatch%" + Aesica.HCEngine.powerUnlocksFrom("Blazing Lockbox or " + UNLOCK_COLLECTOR, 1, UNLOCK_PURPLE_FOIL), Power.TYPE_NORMAL, true);
...
dataPower[dataPower.length] = new Power(1, 1, 4, "Prismatic Detonation", 1, 10, 1, 0, 200, 90, "Targets foe (10 max)/100 feet/25 foot Sphere", "Ultimate/Ranged AoE Damage", "The damage type this power deals is based on the last direct damage power you used.<br /><br />If no power has recently been used, instead picks a damage type at random.<br /><br />Applies Overpower to affected targets. %Overpower%" + Aesica.HCEngine.powerUnlocksFrom("Anniversary"), Power.TYPE_NORMAL, true);
dataPower[dataPower.length-1].insertAdvantage("Commanding Presence", 1, null, "%UltimateChallenge%");
dataPowerAlias["Prismatic Detonation"] = new PowerAlias(dataPower[dataPower.length-1]);
//------------------------------------------------------------------------------
...
dataPower[dataPower.length] = dataPowerAlias["Prismatic Detonation"].replicate(1, 2);
//------------------------------------------------------------------------------
...
dataPower[dataPower.length] = new Power(1, 3, 3, "Gravitic Ripple", 0.5, 0.5, 0.5, 0, [15,12], 20, "Affects foe (5 max)/25 foot Sphere", "Ranged AoE Damage/Repel", "Deals 116 Crushing damage every 0.5 seconds and Repels targets away 8.3 feet.  This amount increases the longer you maintain this power.  This power's damage is doubled if the target is immune to Knock effects." + Aesica.HCEngine.powerUnlocksFrom(UNLOCK_ONSLAUGHT, 10000, "Villain Tokens"));
...
dataPower[dataPower.length] = dataPowerAlias["Prismatic Detonation"].replicate(1, 3);
...
dataPower[dataPower.length] = dataPowerAlias["Prismatic Detonation"].replicate(1, 4);
...
dataPower[dataPower.length] = new Power(1, 5, 1, "Frigid Determination", 1, 2.5, 0, 2.5, 20, 0, "Form (Dexterity)", "Buff/Form/Focus", "Gives you a stacking buff that increases your melee damage, as well as your ranged damage to a lesser degree.<br /><br />+ You gain a stack whenever you apply or refresh Chill on a target, or when you Shatter an Ice Structure<br />+ Each time you gain a stack, existing stacks are refreshed and you gain energy.<br />+ Stacks up to 8 times, lasts 20 seconds, and can only gain 1 stack every 4 seconds.<br />- Increases energy costs by 10%.", Power.TYPE_FORM);
...
dataPower[dataPower.length] = dataPowerAlias["Prismatic Detonation"].replicate(1, 5);
...
dataPower[dataPower.length] = new Power(2, 6, 4, "Showdown", 0.5, 5, 0.5, 0, [67,48], 60, "Affects foe (10 max)/50 feet/180 degree Cone", "Ultimate/Ranged AoE Damage/Root", "Deals Piercing damage and Roots targets for 8 seconds.  Each hit refreshes the Root duration.<br /><br />While maintaining this power, you become immune to most Control effects and gain 200% resistance to all Knock effects." + Aesica.HCEngine.powerUnlocksFrom("Western Lockbox or " + UNLOCK_COLLECTOR, 1, UNLOCK_PURPLE_FOIL), Power.TYPE_NORMAL, true);
...
dataPower[dataPower.length] = new Power(2, 7, -1, "Energy Blaster", .5, 4, .5, 0, 0, 0, "Targets foe/50 feet", "Energy Builder/Ranged/Plasma Burn", "Deals Particle damage to the target and generates energy.  The first hit has a 15% chance to apply Plasma Burn. %PlasmaBurn%", Power.TYPE_ENERGY_BUILDER, false, true);
dataPower[dataPower.length-1].insertAdvantage("It Burns!", 2, null, "This power now has a chance every hit to apply Plasma Burn.");
dataPower[dataPower.length-1].insertStockAdvantages("AM");
...
dataPower[dataPower.length-1].insertAdvantage("Sonic Boost", 2, null, "Increases the base damage of this power by 30% against targets affected by Disorient.");
dataPower[dataPower.length-1].insertStockAdvantages("AM/CS");

dataPower[dataPower.length] = new Power(2, 7, 3, "Pulse Beam Rifle", 0.5, 4, 5, 0, [36,28], 0, "Targets foe/100 feet", "Ranged Damage", "Single target Particle damage. The amount of damage this power deals is highly erratic.<br /><br />Critical Chance and Critical Severity with this power increase every period. This bonus resets when the maintain ends.");
dataPower[dataPower.length-1].insertAdvantage("Time Alteration", 2, null, "+ While you maintain this power, the cooldown on your Gadgeteer powers will be reduced by .25 seconds every hit.<br /><br />-Does not affect Ultimate or Active Powers.");
dataPower[dataPower.length-1].advantageList.push(PowerAdvantage.legacyConstructor(3, 'Finite Improbability Engine', 'Finite Improbability Engine', 2, null, 'The Critical Strike and Severity effect on this power is increased, but no longer increases the longer you maintain this power.<br /><br /> Increases this power\'s damage by one rank.'));
dataPower[dataPower.length-1].insertStockAdvantages("AM/CS");
...
dataPower[dataPower.length] = new Power(2, 9, 2, "Chest Rocket Assault", .5, 5, .5, 0, 0, 0, "Targets foe (5 max)/50 feet/2 foot Cylinder", "Chest Slot/Ranged AoE Damage", "Deals Crushing Damage to targets in front of you.");
dataPower[dataPower.length-1].insertAdvantage("Concussive Blast", 2, null, "This power gains a chance to Knock Down affected targets");
dataPower[dataPower.length-1].insertStockAdvantages("AM/CS");
...
dataPower[dataPower.length] = new Power(3, 11, 4, "Vorpal Blade", 1, 0, 0, 0, 106, 60, "Targets foe (10 max)/15 feet/20 foot Sphere", "Ultimate/Melee AoE Damage", "Deals Slashing damage to all targets, hitting 5 times and causing them to Bleed. %Bleed%<br /><br />The damage this power deals is based on the number of Focus stacks you have." + Aesica.HCEngine.powerUnlocksFrom("Mayhem Lockbox or " + UNLOCK_COLLECTOR, 1, UNLOCK_PURPLE_FOIL), Power.TYPE_NORMAL, true);
...
dataPower[dataPower.length] = new Power(6, 20, 4, "Endbringer's Grasp", 0.67, 2, 0, 2, 111, 60, "Targets foe/50 feet", "Ultimate/Ranged AoE Damage/Corruption/Curse", "Deals 129 Dimensional damage every second for 16 seconds to up to 10 foes within 25 feet.<br /><br />Every 3 seconds, the portal applies Fear to each target.  %Fear%<br /><br />Every 3 seconds, foes affected by Fear are also affected by Corruption for 7 seconds, forcing them to fight for you temporarily.  After Coruption expires, Henchmen take -50% Health Points in damage, and Villains take -25% Health Points in damage." + Aesica.HCEngine.powerUnlocksFrom("Villain Lockbox or " + UNLOCK_COLLECTOR, 1, UNLOCK_PURPLE_FOIL), Power.TYPE_NORMAL, true);
dataPowerAlias["Endbringers Grasp"] = new PowerAlias(dataPower[dataPower.length-1]);

dataPower[dataPower.length] = new Power(6, 20, 4, "Crashing Incantation", 0.67, 1.83, 0, 1.83, 208, 60, "Targets foe (10 max)/50 feet/25 foot Sphere", "Ultimate/Ranged AoE Damage/Corruption/Curse", "+ Deals Magic damage to targets within a 20 foot radius.<br />+ Applies Jinx to the target, reducing their movement by 15% for 8 seconds.  When the effect expires, affected foes are Knocked Down.<br />+ Jinx is a type of Curse.<br />+ Applies Overpower to affected targets. %Overpower" + Aesica.HCEngine.powerUnlocksFrom("Arcane Lockbox or " + UNLOCK_COLLECTOR, 1, UNLOCK_PURPLE_FOIL), Power.TYPE_NORMAL, true);
...
dataSpecializationTree[dataSpecializationTree.length-1].specializationList.push(new Specialization(0, "Preparation", "Supernatural_SoulMesmerism", 1, 2, "Your Secondary Super Stats now grant Defense."));
dataSpecializationTree[dataSpecializationTree.length-1].specializationList.push(new Specialization(1, "Revitalize", "Celestial_Seraphim", 2, 3, "Your Energy Builder reduces the remaining recharge time of all your currently recharging abilities by 2/4/6%. This effect can only occur once every 6 seconds."));
dataSpecializationTree[dataSpecializationTree.length-1].specializationList.push(new Specialization(2, "Tactician", "Specialization_Tactician", 1, 3, "Your Secondary Super Stats now grant Offense."));
...
dataSpecializationTree[dataSpecializationTree.length-1].specializationList.push(new Specialization(4, "Enlightened", "Mentalist_MindLink", 1, 3, "Your cooldown reduction from items now grants Bonus Healing."));
